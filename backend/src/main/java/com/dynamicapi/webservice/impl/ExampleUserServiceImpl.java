...
import com.dynamicapi.webservice.ExampleUserService;
...
@WebService(serviceName = "ExampleUserService",//對外發布的服務名
        ...
        endpointInterface = "com.dynamicapi.webservice.ExampleUserService")//服務接口全路徑, 指定做SEI（Service EndPoint Interface）服務端點接口
@Component
